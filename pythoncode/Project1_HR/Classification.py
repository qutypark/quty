...
# 0. read dataset 
# data: test and assessment data of in-house company /  test data of candidates

# 0.1 standard data = test and assessment data of in-house company
train=pd.read_excel("C:/local",encoding="cp932")
# Lable: categorial (Ordinal)=  H/M/L
# Explanatory variable:numerical(Continuous)= score of each test
...
# 5.2 ML: Since dataset is too small, there is high risk of overfitting -> ensemble library should be needed
#RandomForest
